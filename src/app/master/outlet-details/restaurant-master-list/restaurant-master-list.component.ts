...
@Component({
  selector: 'app-restaurant-master-list',
  templateUrl: './restaurant-master-list.component.html',
  styleUrls: ['./restaurant-master-list.component.scss']
})
export class RestaurantMasterListComponent implements OnInit {
