...
@Component({
  selector: 'app-block-time-slots-list',
  templateUrl: './block-time-slots-list.component.html',
  styleUrls: ['./block-time-slots-list.component.scss']
})
export class BlockTimeSlotsListComponent implements OnInit {
