...
@Component({
  selector: 'app-channel-management-list',
  templateUrl: './channel-management-list.component.html',
  styleUrls: ['./channel-management-list.component.scss']
})
export class ChannelManagementListComponent implements OnInit {
