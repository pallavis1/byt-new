...
@Component({
  selector: 'app-email-and-sms-config-master-list',
  templateUrl: './email-and-sms-config-master-list.component.html',
  styleUrls: ['./email-and-sms-config-master-list.component.scss']
})
export class EmailAndSMSConfigMasterListComponent implements OnInit {
