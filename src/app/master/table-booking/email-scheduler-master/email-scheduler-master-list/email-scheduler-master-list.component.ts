...
@Component({
  selector: 'app-email-scheduler-master-list',
  templateUrl: './email-scheduler-master-list.component.html',
  styleUrls: ['./email-scheduler-master-list.component.scss']
})
export class EmailSchedulerMasterListComponent implements OnInit {
