...
@Component({
  selector: 'app-flag-master-list',
  templateUrl: './flag-master-list.component.html',
  styleUrls: ['./flag-master-list.component.scss']
})
export class FlagMasterListComponent implements OnInit {
