...
@Component({
  selector: 'app-restaurant-setting-list',
  templateUrl: './restaurant-setting-list.component.html',
  styleUrls: ['./restaurant-setting-list.component.scss']
})
export class RestaurantSettingListComponent implements OnInit {
