...
@Component({
  selector: 'app-bot-event-master-list',
  templateUrl: './bot-event-master-list.component.html',
  styleUrls: ['./bot-event-master-list.component.scss']
})
export class BOTEventMasterListComponent implements OnInit {
