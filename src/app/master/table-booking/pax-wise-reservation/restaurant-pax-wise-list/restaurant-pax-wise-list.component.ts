...
@Component({
  selector: 'app-restaurant-pax-wise-list',
  templateUrl: './restaurant-pax-wise-list.component.html',
  styleUrls: ['./restaurant-pax-wise-list.component.scss']
})
export class RestaurantPaxWiseListComponent implements OnInit {
