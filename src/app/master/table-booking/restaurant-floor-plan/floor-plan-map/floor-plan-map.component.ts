...
@Component({
  selector: 'app-floor-plan-map',
  templateUrl: './floor-plan-map.component.html',
  styleUrls: ['./floor-plan-map.component.scss']
})
export class FloorPlanMapComponent implements OnInit {
  ...
  constructor() { 
    ...
    //     this.tbottom.parentPopup = p;
    
    //     var both = document.createElement("div");
    //     both.className = "resizer-both";
    //     p.appendChild(both);
    //     both.addEventListener("mousedown", initDrag, false);
    //     this.both.parentPopup = p;
    //   }
