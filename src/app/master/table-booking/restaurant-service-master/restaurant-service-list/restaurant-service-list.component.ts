...
@Component({
  selector: 'app-restaurant-service-list',
  templateUrl: './restaurant-service-list.component.html',
  styleUrls: ['./restaurant-service-list.component.scss']
})
export class RestaurantServiceListComponent implements OnInit {
