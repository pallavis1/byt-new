...
@Component({
  selector: 'app-table-master-list',
  templateUrl: './table-master-list.component.html',
  styleUrls: ['./table-master-list.component.scss']
})
export class TableMasterListComponent implements OnInit {
