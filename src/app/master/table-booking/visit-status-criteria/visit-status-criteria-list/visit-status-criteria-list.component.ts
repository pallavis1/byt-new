...
@Component({
  selector: 'app-visit-status-criteria-list',
  templateUrl: './visit-status-criteria-list.component.html',
  styleUrls: ['./visit-status-criteria-list.component.scss']
})
export class VisitStatusCriteriaListComponent implements OnInit {
